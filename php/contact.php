...
$success = $error = $errName = $errEmail = $errMessage = $errHuman = "";
$email = $human = $name = $message = $from = $to = $subject = "";
$result = "";
    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-11 ">
            <div class="inner-main-content">
                  ...
                  <h1 class="page-header text-center">Contact Form Example</h1><br>
                    <div class="col-md-4">
                          <img src="../images/email_delivery.png" style="float:left; width:100%;">
                    </div>
                    <div class="col-md-6">
